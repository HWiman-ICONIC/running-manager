...
AppVerName=RunningManager 64-bit
AppVersion=1.7
...
DefaultDirName={pf}\RunningManager
...
[Files]
Source: "./out/build/x64-Release/bin/RunningManager.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "./doc/rmhelp.zip"; DestDir: "{app}"; Flags: ignoreversion
