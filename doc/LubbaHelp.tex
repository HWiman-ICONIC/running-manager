...
\title{80/20 Running Manager v1.8}
\author{\center{
\image{}{8020Running.png}

\urlref{RunningManager}{http://www.wiman.nu/rm}}}
...
\copyright{} \bf{2022 (Software) \urlref{Håkan Wiman}{http://www.wiman.nu/rm}}
...
\item{Scroll to "Other Calendars" and click the plus sign and select "Create New Calendar".

\image{}{gc1.png}}
\item{Enter a Calendar Name and click "Create Calendar".

\image{}{gc2.png}}
\item{In the settings menu to the left, select "Import & export".

\image{}{gc3.png}}
\item{Browse to the *.csv file and click Open in the file menu. Select your newly created Calendar, e.g. "Stockholm Marathon", in the
...
\image{}{gc5.png}}
 ...
 \itemize{
\item{Click on the clandar, e.g. "Stockholm marathon" and scroll to the bottom of the page.}
\item{Click Delete under Remove calendar. 
...
\end{tabular} 
 ...
 \urlref{here (64-bit Windows)}{http://www.wiman.nu/runningmanager/download/setup64.exe}. 
 ...
 \section{Version 1.8, 2022-02-04}
 
 \subsection{Bug fixes}
 \itemize{
 \item{ Changed broken web page to buy "80/20 Running" book. }
 \item{ Updated documentation on how to \helpref{add training plan to Google Calendar}{Export}. }
 }
